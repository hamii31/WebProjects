...
namespace Library.Services
{
    public class BookService : IBookService
    {
        ...
        {
            bool alreadyAdded = await dbContext.IdentityUserBooks.AnyAsync(ub => ub.CollectorId == userId
            && ub.BookId == book.Id);
        ...
        public async Task<BookViewModel?> GetBookByAsync(int id)
        {
            return await this.dbContext.Books.Where(b => b.Id == id).Select(b => new BookViewModel
            {
                Id = b.Id,
                Title = b.Title,
                Author = b.Author,
